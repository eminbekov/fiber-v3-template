...
func (x *UpdateUserRequest) GetRequesterId() string {
	if x != nil {
...
const file_proto_user_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x18proto/user/v1/user.proto\x12\auser.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xf3\x01\n" +
	"\x04User\x12\x0e\n" +
	...
	"\n" +
	"DeleteUser\x12\x1a.user.v1.DeleteUserRequest\x1a\x1b.user.v1.DeleteUserResponseBAZ?github.com/eminbekov/fiber-v3-template/gen/proto/user/v1;userv1b\x06proto3"
